/*
 * Archivo: T_INTRDBSXMMYRL_653.java
 * Fecha: 2021-02-04T03:42:25Z
 *
 ...
 * T_INTRDBSXMMYRL_653 - FormGrupo 
 *
 */
@Path("/INTRD/PREBA/T_INTRDBSXMMYRL_653")
@Component
@Service({T_INTRDBSXMMYRL_653.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=INTRD)(task.submodule=PREBA)(task.id=T_INTRDBSXMMYRL_653)(task.version=1.0.0))")
,@Reference(name="VW_GRUPOTQGEB_453", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_GRUPOTQGEB_453)(view.version=1.0.0))")
...
public class T_INTRDBSXMMYRL_653 {
